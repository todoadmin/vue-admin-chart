...
<p align="center">
    <a href="https://github.com/microsoft/TypeScript">
        <img src="https://img.shields.io/badge/TS-4.7.x-blue" alt="TS">
    </a>
...
> TodoAdmin-Vue版：是一个集成管理后台端模板解决方案，项目采用TS脚本语言，基于Vue 3.x/Vue-cli 5.x/Vue-router 4.x + Axios 0.2.x + Element-plus 2.2.x + Pinia 2.x + ECharts 5.3.2等搭建，项目是以Composition api风格编写。
...
| [vue-jsonp]          | [![vue-jsonp-ico]][vue-jsonp]                  | Jsonp数据请求 |
...
1. 支持前后端路由菜单权限和功能按钮权限控制
2. 采用实时接口传输数据，让你事半功倍
3. 偏好数据、主题切换、多国语言切换等配置
4. 支持原生css和scss 自动排序，eslint 自动修复
5. axios 二次封装，支持多种模式和参数方式
6. websocket 封装，支持实时数据传输方式
7. 支持MD5/RSA加密登录
8. 支持https数据加密传输
9. 使用CDN分发项目样式css和js、图片，让速度飞起来
10. 支持全屏操作
